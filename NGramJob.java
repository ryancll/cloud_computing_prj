...
public class NGramJob implements Tool{
    ...
    public static class NGramMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
     ...
     //   private Pattern space_pattern = Pattern.compile("[ ]");
        ...
        protected void map(LongWritable key, Text value,
            ...
            int textSize = value.toString().length();
            String[] tokens = new String[textSize];
            for (int i=0; i < textSize ;i++){
                tokens[i] = value.toString().substring(i,i+1);
            }
    ...
    public static class MyReducer
        ...
        public void reduce(Text key, Iterable<IntWritable> values, Context context)
            ...
            // how to get map to sort output by value (numerically), instead of key?
